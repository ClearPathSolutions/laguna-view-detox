...
export const GoogleIcon = (p: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
    <path d="M12.24 10.29v3.53h5.85c-.24 1.5-1.76 4.42-5.85 4.42-3.53 0-6.4-2.92-6.4-6.52s2.87-6.52 6.4-6.52c2 0 3.35.85 4.12 1.59l2.8-2.7C17.36 1.5 15.05.5 12.24.5 6.6.5 2.04 5.06 2.04 11.72S6.6 22.94 12.24 22.94c5.9 0 9.8-4.14 9.8-9.97 0-.67-.07-1.18-.16-1.69h-9.64z" />
  </svg>
);
